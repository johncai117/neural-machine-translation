...
"""
Usage:
    python vocab.py --train_src <train_src_file> --train_tgt <train_tgt_file> --vocab_file <vocab_file> [options]
...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_src", default=None, type=str, help="train source file", required=True)
    parser.add_argument("--train_tgt", default=None, type=str, help="train target file", required=True)
    parser.add_argument("--vocab_file", default="voab.json", type=str, help="vocab file")
    parser.add_argument("--size", default=5000, type=int, help="vocab size")
    parser.add_argument("--freq_cutoff", default=2, type=int, help="frequency cutoff")
